...
const char *WINDOWTITLE = { "OpenGL / Project 2 -- Bradley Martin" };
...
Display()
{
	...
	glLoadIdentity( );
	glColor3f( 1., 1., 1. );
	DoRasterString( 5., 5., 0., (char *)"Project 2" );
